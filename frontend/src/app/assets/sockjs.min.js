  ...
  })(
    {
        ...
        function (t, e) {
          ...
          r(n, i),
            ...
            (n.prototype.emit = function (t) {
              ...
              if (e)
                for (
                  var n = Array.prototype.slice.call(arguments, 1), r = 0;
                  r < e.length;
                  r++
                )
                  e[r].apply(this, n);
          ...
          e.exports = function (t, e) {
            ...
            t.bootstrap_iframe = function () {
              ...
              var s = function (r) {
                if (
                  r.source === parent &&
                  ("undefined" == typeof c && (c = r.origin), r.origin === c)
                ) {
                  var s;
                  try {
                    s = i.parse(r.data);
                  ...
                  if (s.windowId === a.currentWindowId)
                    switch (s.type) {
                      case "s":
                        ...
                        if (
                          !n.isOriginEqual(v, u.href) ||
                          !n.isOriginEqual(m, u.href)
                        )
                          throw new Error(
          ...
          function n(t, e) {
            ...
            i.call(this),
              ...
              this.ir.once("finish", function (t, e) {
                (n.ir = null), n.emit("message", o.stringify([t, e]));
              });
          }
          var r = t("inherits"),
          ...
          (function (n) {
            ...
            a(r, b),
              ...
              (r.prototype._connect = function () {
                for (
                  ...
                  if (
                    t.needBody &&
                    (!n.document.body ||
                      ("undefined" != typeof n.document.readyState &&
              ...
              (r.prototype._transportClose = function (t, e) {
                return (
                  this._transport &&
                    ...
                    (this.transport = null)),
                  i(t) || 2e3 === t || this.readyState !== r.CONNECTING
                    ? void this._close(t, e)
                    : void this._connect()
                );
              }),
              ...
              (r.prototype._close = function (t, e, n) {
                var i = !1;
                if (
                  (this._ir && ((i = !0), this._ir.close(), (this._ir = null)),
                  this._transport &&
          ...
          p(
            i,
            {
              indexOf: function (e) {
                ...
                var i = 0;
                for (
                  arguments.length > 1 && (i = t(arguments[1])),
        ...
        function (t, e) {
          (function (n) {
            ...
            function r(t) {
              ...
              var s = a.addQuery(
                t,
                "c=" + encodeURIComponent(i.WPrefix + "." + this.id)
              );
        ...
        function (t, e) {
          (function (n) {
            ...
            e.exports = function (t, e, n) {
              ...
              var h = function (t) {
                c.onerror &&
                  ((c.onreadystatechange = c.onerror = c.onload = null),
                  setTimeout(function () {
      ...
      40: [
        function (t, e) {
          ...
          r(n, i),
            (n.enabled = function (t) {
              return t.cookie_needed || t.nullOrigin
                ? !1
                : s.enabled && t.sameScheme;
            }),
          ...
          (function (n) {
            ...
            e.exports = {
              ...
              unloadAdd: function (t) {
                ...
                var e = r.string(8);
                return (
                  (i[e] = t), o && setTimeout(this.triggerUnloadCallbacks, 0), e
                );
              },
                  ...
                  c = function (t, e) {
                    try {
                      s &&
                        s.contentWindow &&
                        setTimeout(function () {
                          s.contentWindow.postMessage(t, e);
                        }, 0);
                    } catch (n) {}
                  };
                return (
      ...
      50: [
        function (t, e) {
          ...
          e.exports = {
            string: function (t) {
              for (
                var e = r.length, i = n.randomBytes(t), o = [], s = 0;
                t > s;
                s++
              )
              ...
              filterToEnabled: function (e, n) {
                ...
                return (
                  ...
                  t.forEach(function (t) {
                    t &&
                      ("websocket" !== t.transportName || n.websocket !== !1) &&
          ...
          (function (e) {
            (function () {
              function i(t, e) {
                      ...
                      if (c) {
                        ...
                        try {
                          c =
                            ...
                            "[null]" == u([m]) &&
                            "null" == u(null) &&
                            "[null,null,null]" == u([m, b, null]) &&
                            u({ a: [s, !0, !1, null, "\x00\b\n\f\r	"] }) == a &&
                            "1" === u(null, s) &&
                            "[\n 1,\n 2\n]" == u([1, 2], null, 1) &&
                            ...
                            '"-000001-01-01T00:00:00.000Z"' ==
                              u(new l(-621987552e5)) &&
                            '"1969-12-31T23:59:59.999Z"' == u(new l(-1));
                        } catch (f) {
                          c = !1;
                        }
                      }
                ...
                "object" == typeof d &&
                  d &&
                  ((e.stringify = d.stringify), (e.parse = d.parse));
                var p,
                  v,
                  m,
                  y = a.prototype,
                    ...
                    var k = {
                      ...
                      U = function (t, e, n, r, i, o, s) {
                        ...
                        if ("object" == typeof a && a)
                          if (((u = b.call(a)), u != _ || p.call(a, "toJSON")))
                              ...
                              if (
                                ...
                                if (46 == o.charCodeAt(M)) {
                                  for (
                                    n = ++M;
                                    s > n &&
                                    ((i = o.charCodeAt(n)), i >= 48 && 57 >= i);
                                    n++
                                  );
                                  n == M && J(), (M = n);
                                }
                                if (
                                  ((i = o.charCodeAt(M)), 101 == i || 69 == i)
                                ) {
                                  for (
                                    i = o.charCodeAt(++M),
                                      (43 == i || 45 == i) && M++,
      ...
      56: [
        function (t, e) {
            ...
            for (
              ...
              (c = a[m]),
                ...
                l !== l
                  ...
                  ? ~(f = t.indexOf(l)) &&
                    ("number" == typeof c[2]
                      ? ((v[h] = t.slice(0, f)), (t = t.slice(f + c[2])))
                      : ((v[h] = t.slice(f)), (t = t.slice(0, f))))
                  : (f = l.exec(t)) &&
                    ((v[h] = f[1]), (t = t.slice(0, t.length - f[0].length))),
                (v[h] =
                  v[h] || (c[3] || ("port" === h && d) ? e[h] || "" : "")),
          ...
          (n.prototype.set = function (t, e, n) {
            ...
            return (
              "query" === t
                ? ("string" == typeof e && (e = (n || o.parse)(e)), (i[t] = e))
                : "port" === t
                ? ((i[t] = e),
                  r(e, i.protocol)
                ...
                ? ((i[t] = e),
                  /\:\d+/.test(e) &&
                    ((e = e.split(":")), (i.hostname = e[0]), (i.port = e[1])))
                : (i[t] = e),
              (i.href = i.toString()),
              i
            );
