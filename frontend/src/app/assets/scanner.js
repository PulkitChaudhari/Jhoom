...
(function () {
      ...
      h = {
        ...
        getJREs: function () {
          ...
          if (this.isPluginInstalled()) {
            for (
              var n = this.getPlugin(), i = n.jvms, r = 0;
              r < i.getLength();
              r++
            ) {
              t[r] = i.get(r).version;
        ...
        writeAppletTag: function (e, t) {
          ...
          for (var u in t) {
            "codebase_lookup" == u && (o = !0),
              ("object" == u || "java_object" == u || "java_code" == u) &&
                (s = !1),
  ...
  ha = n(
    "license",
    "com_asprise_scan_app_license" in window
      ? window.com_asprise_scan_app_license
      : null
  );
  ...
  function U(a, b, c, d, f, e, k, m, v, aa) {
    ...
    if (!V() && !q)
      return (
        p && P()
          ? null != E && 1e4 < new Date().getTime() - E.getTime() && xa(!0)
          : xa(!0),
        !1
      );
    ...
    if ("function" !== typeof a)
      return (
        W("asprise_scanner_js_call_function requires a valid callbackFunc"), !1
      );
  ...
  function Ca(a) {
    var b = null;
    if ("string" === typeof a && 6 < a.length && "<error" == a.substr(0, 6))
      throw a;
    if (a && 7 < a.length && "SYSTEM/" == a.substr(0, 7))
      ...
      b instanceof Array
        ...
        : X(
            !1,
            "JSON returned from WebSocket is not array",
            null,
            null,
            null,
            null,
    ...
    if (ea)
      if (w) (y = void 0), w.close();
        ...
        a =
          ...
          "http:" == window.location.href.substr(0, 5)
            ? "ws://127.0.0.1"
            : "wss://local.scannerjs.com";
        var b = 3 < a.length && "wss" == a.substr(0, 3).toLowerCase();
        void 0 == u
          ? (u = t)
          : void 0 != y && 1e4 > new Date().getTime() - y && (u += 1);
        u % 2 != (b ? 0 : 1) && (u += 1);
        if (u < t || u > ja)
          O("Failed to connect to WebSocket server.", !0),
            ...
            !(0 < N) || Ia < N
              ? S()
              : ((Ia = 0), H && H("failed-to-connect-final"));
        else {
          y = new Date().getTime();
          try {
            b = Ja;
  ...
  function Ka() {
    for (
      var a = document.getElementsByTagName("script"), b = 0;
      b < a.length;
      b++
    ) {
      var c = a.item(b),
        d = new RegExp(L + "\\.js(\\?\\w*)?$");
      if (c.src && c.src.match(d))
        return (a = c.src), a.substring(0, a.lastIndexOf("/") + 1);
    }
  ...
  function ua() {
    ...
    -1 < a.indexOf("FORCE_REFRESH") &&
      ...
      (a = a.replace(
        /FORCE_REFRESH/g,
        "FORCE_REFRESH_" + new Date().getTime()
      ));
    var b = document.getElementById("com_asprise_scan_applet");
    null == b &&
      ((b = wa.versionCheck("1.7.0_45+")
        ? "asprise_scan.jar"
        : "asprise_scan-legacy.jar"),
      (b = Y({
        name: "applet",
        attributes: {
        ...
        children: [
          {
            name: "param",
            attributes: { name: "permissions", value: "all-permissions" },
          },
          {
            name: "param",
          ...
          {
            name: "param",
            attributes: { name: "java_arguments", value: "-Xmx512m" },
          },
          {
            name: "param",
  ...
  function La(a) {
    ...
    if (a || b) {
      if (!b) {
          ...
          children: [
            ...
            },
            {
              ...
              attributes: {
                ...
                class:
                  "asprise-web-scan-dialog asprise-web-scan-dialog-display",
                style: "display: none",
              },
              children: [
                {
                ...
                },
                {
                  ...
                  children: [
                    {
                      name: "h2",
                      attributes: { text: "Please complete one-time setup" },
                    },
                    {
                      name: "table",
                      attributes: {
                      ...
                      children: [
                        {
                          ...
                          children: [
                            {
                              name: "td",
                              attributes: { width: "33%", class: "download" },
                            },
                            {
                              name: "td",
                              attributes: { width: "33%", class: "run" },
                            },
                            {
                              name: "td",
                              attributes: { width: "33%", class: "enjoy" },
                            },
                          ],
                        },
                        {
                          name: "tr",
                          attributes: { class: "after_icon" },
                          children: [
                            { name: "td", attributes: { colspan: "3" } },
                          ],
                        },
                        {
                          name: "tr",
                          ...
                          children: [
                            ...
                            {
                              name: "td",
                              attributes: { class: "enjoy" },
                              children: [
                                { name: "h3", attributes: { text: "Scan" } },
                                {
                                  name: "p",
                                  attributes: {
            ...
            },
            {
              ...
              attributes: {
                ...
                class:
                  "asprise-web-scan-dialog small-dialog asprise-web-scan-setup-ok-dialog",
                style: "display: none",
              },
              children: [
                {
                ...
                {
                  name: "div",
                  attributes: { class: "asprise-web-scan-setup-ok" },
                  children: [
                    { name: "div", attributes: { class: "icon" } },
                    {
                      name: "div",
                      children: [
                        {
                          name: "p",
                          attributes: { text: "All set. You may scan now." },
                        },
                      ],
                    },
                  ],
        ...
        c.appendChild(Y(b));
        if (
          (b = document.getElementById("asprise-web-scan-setup-dialog-wrapper"))
        ) {
          ...
          d = setInterval(function () {
            if (0 >= c) {
              ...
              for (var b = 0; b < a.length; b++)
                a.item(b).style.display = "none";
            } else {
              for (b = 0; b < a.length; b++)
                a.item(b).style.opacity = c.toFixed(1);
              c -= 0.1;
            }
          }, 50);
  }
  function sa() {
    for (
      var a = !1, b = document.getElementsByTagName("link"), c = 0;
      c < b.length;
      c++
    ) {
      var d = b.item(c),
  ...
  function ca(a, b) {
    if (!R())
      return W("base64ToBlob() is not supported in legacy browsers."), null;
  ...
  function va() {
    var a = wa.getJREs();
    return void 0 == a || "" == a || (a instanceof Array && 0 == a.length)
      ? !1
      : !0;
  }
  function P() {
  ...
  function Y(a) {
    ...
    if (a.children instanceof Array)
      for (a = a.children, b = 0; b < a.length; b++)
        a[b] && c.appendChild(Y(a[b]));
    return c;
  }
  function O(a, b) {
    if (!(da > (b ? 16 : 4)))
  ...
  window.scannerjs.getSaveResponse = function (a) {
    ...
    if ("object" === typeof a && a.output instanceof Array) {
      ...
      for (var b = 0; b < a.length; b++) {
        var c = a[b];
        if ("save" == c.type || "save-thumbnail" == c.type)
    ...
    if (b instanceof Array && 0 != b.length) {
      ...
      if (null == e) W("Form doesn't exist: " + a);
        ...
        for (d = 0; d < b.length; d++)
          (f = b[d]),
            f.b ? a.append(ma, ca(f.src, f.mimeType)) : a.append(oa, f.src);
  ...
  window.scannerjs.hasWebSocketSupport = function () {
    var a =
      ("WebSocket" in window && void 0 != window.WebSocket) ||
  ...
  "ScannedImage" in window ||
    (window.ScannedImage = window.scannerjs.ScannedImage);
  window &&
